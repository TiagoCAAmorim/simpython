    ...
    def test_read_elements(self):
        ...
        def _test_equal(true_result, file_read, partial_true_result=False):
            ...
            if partial_true_result:
                ...
                self.assertTrue(have_same_elements(file_read, true_result),
                                error_msg)
        ...
        comp_ = sr3_file._component_list  # pylint: disable=protected-access
        file_read = comp_.values()
        _test_equal(true_result, file_read)

        print(
            "File open calls: " +
            f"{sr3_file._open_calls}"  # pylint: disable=protected-access
        )
